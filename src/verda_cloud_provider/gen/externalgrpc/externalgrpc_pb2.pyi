...
class NodeGroup(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        minSize: _Optional[int] = ...,
        maxSize: _Optional[int] = ...,
        debug: _Optional[str] = ...,
    ) -> None: ...
...
class NodeGroupsResponse(_message.Message):
    ...
    def __init__(
        self, nodeGroups: _Optional[_Iterable[_Union[NodeGroup, _Mapping]]] = ...
    ) -> None: ...
...
class NodeGroupForNodeRequest(_message.Message):
    ...
    def __init__(
        self, node: _Optional[_Union[ExternalGrpcNode, _Mapping]] = ...
    ) -> None: ...
...
class NodeGroupForNodeResponse(_message.Message):
    ...
    nodeGroup: NodeGroup
    def __init__(
        self, nodeGroup: _Optional[_Union[NodeGroup, _Mapping]] = ...
    ) -> None: ...
...
class PricingNodePriceRequest(_message.Message):
    ...
    def __init__(
        self,
        node: _Optional[_Union[ExternalGrpcNode, _Mapping]] = ...,
        startTimestamp: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        endTimestamp: _Optional[
            _Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
    ) -> None: ...
...
class GetAvailableGPUTypesResponse(_message.Message):
    ...
    def __init__(
        self, gpuTypes: _Optional[_Mapping[str, _any_pb2.Any]] = ...
    ) -> None: ...
...
class NodeGroupIncreaseSizeRequest(_message.Message):
    ...
    id: str
    def __init__(
        self, delta: _Optional[int] = ..., id: _Optional[str] = ...
    ) -> None: ...
...
class NodeGroupDeleteNodesRequest(_message.Message):
    ...
    def __init__(
        self,
        nodes: _Optional[_Iterable[_Union[ExternalGrpcNode, _Mapping]]] = ...,
        id: _Optional[str] = ...,
    ) -> None: ...
...
class NodeGroupNodesResponse(_message.Message):
    ...
    def __init__(
        self, instances: _Optional[_Iterable[_Union[Instance, _Mapping]]] = ...
    ) -> None: ...
...
class Instance(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        status: _Optional[_Union[InstanceStatus, _Mapping]] = ...,
    ) -> None: ...
...
class InstanceStatus(_message.Message):
    ...
    def __init__(
        self,
        instanceState: _Optional[_Union[InstanceStatus.InstanceState, str]] = ...,
        errorInfo: _Optional[_Union[InstanceErrorInfo, _Mapping]] = ...,
    ) -> None: ...
...
class InstanceErrorInfo(_message.Message):
    ...
    def __init__(
        ...
        instanceErrorClass: _Optional[int] = ...,
    ) -> None: ...
...
class NodeGroupAutoscalingOptions(_message.Message):
    __slots__ = (
        ...
        "scaleDownUnneededDuration",
        "scaleDownUnreadyDuration",
    ...
    def __init__(
        self,
        scaleDownUtilizationThreshold: _Optional[float] = ...,
        scaleDownGpuUtilizationThreshold: _Optional[float] = ...,
        zeroOrMaxNodeScaling: bool = ...,
        ignoreDaemonSetsUtilization: bool = ...,
        scaleDownUnneededDuration: _Optional[
            _Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]
        ] = ...,
        scaleDownUnreadyDuration: _Optional[
            _Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]
        ] = ...,
        MaxNodeProvisionDuration: _Optional[
            _Union[datetime.timedelta, _duration_pb2.Duration, _Mapping]
        ] = ...,
    ) -> None: ...
...
class NodeGroupAutoscalingOptionsRequest(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        defaults: _Optional[_Union[NodeGroupAutoscalingOptions, _Mapping]] = ...,
    ) -> None: ...
...
class NodeGroupAutoscalingOptionsResponse(_message.Message):
    ...
    def __init__(
        self,
        nodeGroupAutoscalingOptions: _Optional[
            _Union[NodeGroupAutoscalingOptions, _Mapping]
        ] = ...,
    ) -> None: ...
